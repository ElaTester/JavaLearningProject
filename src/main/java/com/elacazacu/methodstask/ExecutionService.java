package com.elacazacu.methodstask;
...
public class ExecutionService {
    public static void main(String[] args) {
        ...
        System.out.println("Random Invalid String de X chars:" + DataGeneratorUtil.generateValidRandomString(5));

        Customer elenaConsumer = new Customer("Elena Neaga", 31, "Elena.Neaga@gmail.com");

        System.out.println("Nume obiect Elena: " + elenaConsumer.getName());
        System.out.println("Age obiect Elena: " + elenaConsumer.getAge());
        System.out.println("Email obiect Elena: " + elenaConsumer.getEmail());

        elenaConsumer.setName("Elena Malina");
        elenaConsumer.setAge(1527);
        elenaConsumer.setEmail("ElenMalina@gmail.com");

        System.out.println("Nume obiect ElenaM: " + elenaConsumer.getName());
        System.out.println("Age obiect ElenaM: " + elenaConsumer.getAge());
        System.out.println("Email obiect ElenaM: " + elenaConsumer.getEmail());
